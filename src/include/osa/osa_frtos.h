#ifndef __OSA_FREERTOS_HEADER__
#define __OSA_FREERTOS_HEADER__
...
#include <frtos/stack_macros.h>
#include <frtos/croutine.h>
#include <frtos/deprecated_definitions.h>
#include <frtos/event_groups.h>
#include <frtos/list.h>
#include <frtos/message_buffer.h>
#include <frtos/mpu_prototypes.h>
#include <frtos/mpu_wrappers.h>
#include <frtos/portable.h>
#include <frtos/portmacro.h>
#include <frtos/projdefs.h>
#include <frtos/semphr.h>
#include <frtos/stack_macros.h>
#include <frtos/stddef.h>
#include <frtos/stdint.h>
#include <frtos/stdlib.h>
#include <frtos/stream_buffer.h>
#include <frtos/task.h>
#include <frtos/tick_timer_settings.h>
#include <frtos/timers.h>
...
typedef struct {						// Total 0x0c bytes
	...
	TaskHandle_t	ov_tcb;				// 0x24: Task TCB Pointer
...
typedef struct {						// Total 0x0c bytes
	...
	UINT32	ov_addr;					// 0x1c: Where has waitSem() been called
	UINT32	ov_iCnt;					// 0x20: Semaphore count
	SemaphoreHandle_t	ov_sem;			// 0x24: Semaphore id pointer
} osv_st;
typedef struct {						// Total 0x0c bytes
	...
	UINT16	ov_nMaxnum;					// 0x1c: Maximum number of message
	UINT32	ov_ptr;						// 0x20: Pointer to MSG buffer
	QueueHandle_t	ov_q;				// 0x24: Queue id pointer
} osv_qt;
