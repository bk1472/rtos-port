#ifndef __OSA_ATOM_HEADER__
#define __OSA_ATOM_HEADER__
...
#include <stdarg.h>
#include <atom/atom.h>
#include <atom/atommutex.h>
#include <atom/atomport.h>
#include <atom/atomqueue.h>
#include <atom/atomsem.h>
#include <atom/atomtimer.h>
...
typedef struct {						// Total 0x0c bytes
	...
	ATOM_TCB	*ov_tcb;				// 0x24: Task TCB Pointer
...
typedef struct {						// Total 0x0c bytes
	...
	UINT32	ov_addr;					// 0x1c: Where has waitSem() been called
	ATOM_SEM  *ov_sem;					// 0x20: Semaphore id pointer
} osv_st;
...
typedef struct {						// Total 0x0c bytes
	...
	ATOM_QUEUE	*ov_q;					// 0x20: Queue id pointer
} osv_qt;
