...
#   Copyright(c) 1998-2005 by LG Electronics Inc.                              *
#                                                                              *
#   All rights are reserved. No part of this work may be reproduced, stored    *
#   in a retrieval system, or transmitted by any means without prior written   *
#   permission of LG Electronics Inc.                                          *
#                                                                              *
#   ---------------------------------------------------------------------------*
#                                                                              *
#   FILE NAME	: byteLibarm.s                                                 *
#   VERSION	: 0.1                                                              *
#   AUTHOR	: Baekwon, Choi(baekwon.choi@lge.com, ¿Ã¿Á±Ê)                      *
#                                                                              *
#   DESCRIPTION	: This file has a function to manipulate byte operations       *
#		  Such as byte copy, move, fill                                *
#                 This will be called from memcpy(), memmove(), memset() ...   *
#*******************************************************************************
...
#define	FUNC(a)		_##a
#define LABEL(l)	_##l:
#define _BYTE_ORDER	ENDIAN_TYPE
...
#------------------------------------------------------------------------------*
# Register aliases, will be used in this function                              *
#------------------------------------------------------------------------------*
src	.req	r0		/* Source address			*/
dst	.req	r1		/* Destination address			*/
n	.req	r2		/* Counter register			*/
tmp1	.req	r3		/* Registers temporary used		*/
tmp3	.req	r12		/* Registers temporary used		*/
